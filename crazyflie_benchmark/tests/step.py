...
class StepTest(TestStrategy):
    ...
    Applies a step input on the specified channel (roll, pitch, or thrust) and
    ...
    def _execute_test(self) -> bool:
        ...
        logger.info(f"Applying step input: Roll: {roll}°, Pitch: {pitch}°, "
        ...
        while time.time() - start_time < self.duration:
            ...
            if not self.check_safety():
                logger.warning(f"Step test on {self.channel} interrupted due to safety concerns!")
